...
HD_PWD='C:/Users/alext/Desktop/School/ECEN_340/Traffic_Light_Controller/Traffic_Light_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source traffic_light_controller_top.tcl
