...
HD_PWD='C:/Users/alext/Desktop/School/ECEN_340/Traffic_Light_Controller/Traffic_Light_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log traffic_light_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source traffic_light_controller_top.tcl -notrace
