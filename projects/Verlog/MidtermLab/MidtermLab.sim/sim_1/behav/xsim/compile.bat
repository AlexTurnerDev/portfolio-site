...
REM
REM Generated by Vivado on Sat Nov 08 18:44:03 -0700 2025
...
echo "xvlog --incr --relax -prj grey_counter_top_tb_vlog.prj"
call xvlog  --incr --relax -prj grey_counter_top_tb_vlog.prj -log xvlog.log
