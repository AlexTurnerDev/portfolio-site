...
## Pmod Header JA (TFT Display)
## Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports TFT_CS]
#	set_property IOSTANDARD LVCMOS33 [get_ports TFT_CS]
### Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports TFT_RST]
#	set_property IOSTANDARD LVCMOS33 [get_ports TFT_RST]
### Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports TFT_DC]
#	set_property IOSTANDARD LVCMOS33 [get_ports TFT_DC]
### Sch name = JA4
#set_property PACKAGE_PIN G2 [get_ports TFT_MOSI]
#	set_property IOSTANDARD LVCMOS33 [get_ports TFT_MOSI]
### Sch name = JA7
#set_property PACKAGE_PIN H1 [get_ports TFT_SCLK]
#	set_property IOSTANDARD LVCMOS33 [get_ports TFT_SCLK]
## Sch name = JA8
