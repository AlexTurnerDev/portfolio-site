...
REM
REM Generated by Vivado on Wed Oct 29 09:55:22 -0600 2025
...
echo "xvlog --incr --relax -prj sseg_x4_tb_vlog.prj"
call xvlog  --incr --relax -prj sseg_x4_tb_vlog.prj -log xvlog.log
