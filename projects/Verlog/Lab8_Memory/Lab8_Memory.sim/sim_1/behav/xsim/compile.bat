...
REM
REM Generated by Vivado on Mon Nov 24 18:09:22 -0700 2025
...
echo "xvlog --incr --relax -prj pipelined_multiplier_tb_vlog.prj"
call xvlog  --incr --relax -prj pipelined_multiplier_tb_vlog.prj -log xvlog.log
