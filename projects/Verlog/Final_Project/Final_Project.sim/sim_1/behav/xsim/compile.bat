...
REM
REM Generated by Vivado on Tue Dec 16 19:28:03 -0700 2025
...
echo "xvlog --incr --relax -prj Final_Project_tb_vlog.prj"
call xvlog  --incr --relax -prj Final_Project_tb_vlog.prj -log xvlog.log
